...
export const api = {
  ...
  imagesDelete: (id: string) => G.ImagesDelete(id) as unknown as Promise<number>,
  imagesDeleteUnused: () => G.ImagesDeleteUnused() as unknown as Promise<number>,
...
export interface TcpdumpStartInput {
  ...
  bpf_filter: string;
  max_count: number;
  // engine selects the capture backend: "tcpdump" (default) or "tshark".
  engine?: string;
  root_user: boolean;
  sudo_no_pwd: boolean;
